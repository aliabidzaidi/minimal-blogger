...
const routes: Routes = [
  { path: '', pathMatch: 'full', redirectTo: '/login', canActivate: [IsLoginGuard] },
  { path: 'login', component: LoginComponent, canActivate: [LoginRedirectGuard] },
  { path: 'signup', component: SignupComponent, canActivate: [LoginRedirectGuard] },
  { path: 'home', loadChildren: () => import('./pages/home/home.module').then(m => m.HomeModule), canActivate: [IsLoginGuard] },
